...
namespace Fasetto.Word
{
    ...
    public static class StoryboardHelpers
    {
        ...
        /// <summary>
        /// Adds a slide a from left animation to the stroyboard
        /// </summary>
        ...
        /// <summary>
        /// Adds a slide to left animation to the stroyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the left to start from</param>
        ...
        /// <summary>
        /// Adds a slide a from right animation to the stroyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        ...
        /// <summary>
        /// Adds a slide to right animation to the stroyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        ...
        /// <summary>
        /// Adds a fide in animation to the stroyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the right to start from</param>
        ...
        /// <summary>
        /// Adds a fide out animation to the stroyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the right to start from</param>
        ...
        /// <summary>
        /// Adds a slide a from bottom animation to the stroyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        ...
        /// <summary>
        /// Adds a slide to bottom animation to the stroyboard
        /// </summary>
        /// <param name="storyboard">The storyboard to add the animation to</param>
        /// <param name="seconds">The time the animation will take</param>
        /// <param name="offset">The distance to the bottom to start from</param>
