...
namespace Fasetto.Word
{
    ...
    public partial class PageHost : UserControl
    {
        ...
        public static readonly DependencyProperty CurrentPageProperty =
            DependencyProperty.Register(nameof(CurrentPage), typeof(BasePage), typeof(PageHost), new UIPropertyMetadata(CurrentPropertyChanged));
        ...
        /// <param name="d"></param>
        /// <param name="e"></param>
        private static void CurrentPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            // Get the frames     
